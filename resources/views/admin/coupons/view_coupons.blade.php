                              ...
                              <table id="table_id" class="table table-bordered table-striped table-hover">
                                 ...
                                 @foreach($coupons as $coupon)
                                    <tr>
                                       ...
                                       <td> 
                                          <a href="{{url('/admin/edit-coupon/'.$coupon->id)}}" class="btn btn-add btn-sm" ><i class="fa fa-pencil"></i></button>
                                          <a href="{{url('/admin/delete-coupon/'.$coupon->id)}}" class="btn btn-danger btn-sm" ><i class="fa fa-trash-o"></i> </button>
                                       </td>
                                    </tr>
                                   @endforeach
